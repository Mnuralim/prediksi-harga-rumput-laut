// app/(root)/_components/stats.tsx
"use client";
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-slate-600">
          Sistem Prediksi Harga/Produksi Rumput Laut dengan Regresi Linear
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <div
                className={`w-3 h-3 rounded-full ${
                  totalSeaweedRecords >= 10 ? "bg-green-500" : "bg-yellow-500"
                }`}
              ></div>
              <span className="text-sm text-slate-700">
                {totalSeaweedRecords >= 10
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="p-4 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 hover:border-slate-300 transition-all duration-200 text-left group">
              <Link href={"/test"} className="w-full h-full">
                <TestTube className="w-6 h-6 text-slate-600 group-hover:text-green-600 mb-2 transition-colors" />
