      ...
      <form action={action} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="lg:col-span-2 flex justify-end pt-6 border-t border-slate-200">
          <button
            disabled={pending}
            type="submit"
            className="flex items-center gap-2 px-6 py-2.5 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-900 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
          >
            {pending ? (
              <>
